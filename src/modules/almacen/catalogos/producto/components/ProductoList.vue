...
const tableHeader   = ref([
    ...
    {
        columnLabel:    'Codigo Alterno',
        columnField:    'codigo_alterno',
        sortEnabled:    true,
        class:          "text-start"
    },
    {
    ...
    {
        columnLabel:    'Tipo Inventario',
        columnField:    'inv_tipo_inventario',
        sortEnabled:    true,
        class:          "text-start"
    },
    {
...
permisos.value = store.permisos.filter((element: any) => element.codigo == '044'); // Modulo Almacén Catalogos Producto
    ...
    <div class="card-header border-0 pt-6">
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                <Button label='Nuevo Producto' severity="Primary" icon="pi pi-plus" raised
                    @click="() => { router.push({name: 'producto-nuevo', params: {id: 0}}) }"
        ...
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <FloatLabel variant="on">
                    ...
                    <label for="search" class="ms-10">Buscar en Productos</label>
                </FloatLabel>
            </div>
        </div>
                        ...
                        <td v-for="col in tableHeader" :key="col.columnLabel" :class="col.class">
                            <template v-if="col.columnField === 'actions'">
                                <Button severity="info" icon="pi pi-search" raised
                                    ...
                                    @click="() => { router.push({name: 'producto-consulta', params: {id: item.id}}) }"
                                ...
                                <Button severity="warn" icon="pi pi-pencil" raised
                                    ...
                                    @click="() => { router.push({name: 'producto-edita', params: {id: item.id}}) }"
                            ...
                            <template v-else-if="col.columnField=='inv_tipo_inventario'">
                                {{  item[col.columnField]!['tipo_inventario']  }}
                            </template>
