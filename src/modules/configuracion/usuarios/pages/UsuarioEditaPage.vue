...
const { values, 
    ...
    codigo_pais:    registro.value.codigo_pais,
    telefono_movil: registro.value.telefono_movil,
    rol:            roles.value.find(item => item.id == registro.value.rol_id)!,
    departamento:   departamentos.value.find(item => item.id == registro.value.departamento_id)!,
} });

const [ usuario, usuarioAttr ]                  = defineField('usuario');
const [ password, passwordAttr ]                = defineField('password');
const [ nombre, nombreAttr ]                    = defineField('nombre');
const [ email, emailAttr ]                      = defineField('email');
const [ codigo_pais, codigo_paisAttr ]          = defineField('codigo_pais');
const [ telefono_movil, telefono_movilAttr ]    = defineField('telefono_movil');
const [ rol, rolAttr ]                          = defineField('rol');
const [ departamento, departamentoAttr ]        = defineField('departamento');
...
watch(roles, () => {
    if(roles.value.length > 0 && registro.value.id > 0) {
        rol.value = roles.value.find(item => item.id == registro.value.rol_id)!;
    }
});

watch(departamentos, () => {
    if(departamentos.value.length > 0 && registro.value.id > 0) {
        departamento.value = departamentos.value.find(item => item.id == registro.value.departamento_id)!;
    }
});
        ...
        <form @submit="onSubmit">
            <div class="card-body border-0 pt-0 pb-0">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <InputText id="usuario" v-model="usuario" maxlength="30" v-bind="usuarioAttr"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <InputText id="nombre" v-model="nombre" v-bind="nombreAttr" placeholder="Capture el nombre completo del usuario"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <InputText id="email" v-model="email" v-bind="emailAttr" placeholder="Correo electrónico asociado al usuario"
                ...
                <div class="row mb-3">
                    <div class="col-sm-4">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <InputText id="codigo_pais" v-model="codigo_pais" v-bind="codigo_paisAttr"
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <InputText id="telefono_movil" v-model="telefono_movil" v-bind="telefono_movilAttr" placeholder='Numero del celular del usuario'
