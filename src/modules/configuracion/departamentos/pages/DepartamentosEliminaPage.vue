...
const Eliminar = (departamento: Departamento) => {
    confirm.require({
...
<template> 
    ...
    <div class="card-header border-0 pt-2">
        <h2>Elimina Departamento</h2>
    </div>
    <div v-if="departamento">
        <form @submit.prevent="Eliminar(departamento!)">
            <div class="card-body border-0 pt-0 pb-0">
                ...
                <div class="fv-row mb-5">
                    ...
                    <InputText id="descripcion" v-model="departamento.nombre" maxlength="120" disabled
