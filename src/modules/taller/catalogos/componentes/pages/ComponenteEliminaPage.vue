...
import useComponente from '../composables/useComponente';
...
const Eliminar = (registro: Componente) => {
    confirm.require({
        ...
        <form @submit.prevent="Eliminar(registro!)">
            ...
            <div class="card-footer">
                <Button
                    ...
                    @click="() => { router.push({name: 'componentes'})}">
                </Button>
                <Button
