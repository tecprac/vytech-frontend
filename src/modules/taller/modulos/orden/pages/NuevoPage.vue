            ...
            <div class="card-body border-0 pt-0 pb-0">
                <Toolbar style="border-radius: 2rem; padding: 1rem 1rem 1rem 1.5rem;" size="small" >
                    <template #start>
                        ...
                        <Button v-if="registro.id == 0" rounded raised icon="pi pi-plus" class="ms-2" severity="success" label="Crear"
                            @click="validarDatos(registro)" size="small" :loading="isAdding">
                        </Button>
                        <Button v-if="registro.id > 0" rounded raised icon="pi pi-plus" class="ms-2" severity="success" label="Guardar"
