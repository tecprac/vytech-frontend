                ...
                <Toolbar style="border-radius: 1rem; padding: 1rem 1rem 1rem 1.5rem;" class="bg-secondary" size="small" >
                    <template #start>
                        ...
                        <Button v-if="registro.id > 0" raised icon="pi pi-plus" class="ms-2" severity="success" label="Guardar"
                            @click="validarDatos(registro)" size="small"  :loading="isUpdating">
                        </Button>
                    ...
                    <TabPanels>
                        ...
                        <TabPanel value="0">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-2">
                                    <InputNumber v-model="registro.kms" :min="0.0" :max="99999999999.9" highlight-on-focus
                                        :min-fraction-digits="1" :max-fraction-digits="1" fluid
                                        :pt="{ pcInputText: { root:{ class: 'text-end'}} }">
                                    </InputNumber>
                                </div>
