                ...
                <template v-for="(item, i) in MainMenuConfig" :key="i">
                    <div v-if="item.heading" class="menu-item pt-5">
                        <div class="menu-content">
                            <span v-if="item.keenthemesIcon || item.bootstrapIcon" class="menu-icon">
                                    <i v-if="sidebarMenuIcons === 'bootstrap'" :class="item.bootstrapIcon" class="bi fs-3"></i>
                                    <KTIcon v-else-if="sidebarMenuIcons === 'keenthemes'" :icon-name="item.keenthemesIcon" icon-class="fs-2"/>
                            </span>
                    ...
                    <template v-for="(menuItem, j) in item.pages" :key="j">
                        ...
                        <div v-if="menuItem.sectionTitle 
                                && menuItem.route
                                && storeAuth.secciones.indexOf(menuItem.seccion!) >= 0" :class="{ show: hasActiveChildren(menuItem.route) }" class="menu-item menu-accordion"
                            ...
                            <div :class="{ show: hasActiveChildren(menuItem.route) }" class="menu-sub menu-sub-accordion">
                                <template v-for="(item2, k) in menuItem.sub" :key="k">
                                    <div v-if="item2.heading && storeAuth.modulos.indexOf(item2.codigo!) >= 0" class="menu-item">
                                    ...
                                    <div v-if="item2.sectionTitle && item2.route" :class="{ show: hasActiveChildren(item2.route) }"
                                        ...
                                        <div :class="{ show: hasActiveChildren(item2.route) }" class="menu-sub menu-sub-accordion">
                                            <template v-for="(item3, k) in item2.sub" :key="k">
                                                <div v-if="item3.heading && storeAuth.modulos.indexOf(item3.codigo!) >= 0" class="menu-item">
                                                    <router-link v-if="item3.route"
                                                        class="menu-link" active-class="active" :to="item3.route">
                                                        <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div v-if="item3.sectionTitle && item3.route" :class="{ show: hasActiveChildren(item3.route) }"
                                                    class="menu-item menu-accordion" data-kt-menu-sub="accordion" data-kt-menu-trigger="click">
                                                    <span class="menu-link">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">{{ translate(item3.sectionTitle)}}</span>
                                                        <span class="menu-arrow"></span>
                                                    </span>
                                                    <div :class="{ show: hasActiveChildren(item3.route) }" class="menu-sub menu-sub-accordion">
                                                        <template v-for="(item4, k) in item3.sub" :key="k">
                                                            <div v-if="item4.heading  && storeAuth.modulos.indexOf(item4.codigo!) >= 0" class="menu-item">
                                                                <router-link v-if="item4.route"
                                                                    class="menu-link" active-class="active" :to="item4.route">
                                                                    <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                    </span>
                                                                    <span class="menu-title">{{ translate(item4.heading) }}</span>
                                                                </router-link>
                                                            </div>
                                                        </template>
                                                    </div>
